const Header = () => (
    <header className="bg-green-300 text-black p-5">
      <div className="container bg-white mx-auto flex flex-col md:flex-row justify-between items-center p-3 rounded-md">
        <h1 className="text-xl font-bold">Paw Prints</h1>
        <nav className="flex flex-col md:flex-row md:items-center flex-grow mt-4 md:mt-0">
          <ul className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 mx-auto">
            <li><a href="#" className="hover:underline">Campaigns & Topics</a></li>
            <li><a href="#" className="hover:underline">About</a></li>
            <li><a href="#" className="hover:underline">Services</a></li>
            <li><a href="#" className="hover:underline">Contact</a></li>
          </ul>
          <div className="space-y-2 md:space-y-0 md:space-x-4 mt-4 md:mt-0 ml-auto">
