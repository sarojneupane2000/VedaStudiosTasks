const About = () => (
    <div className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 lg:flex lg:items-start lg:space-x-8">
          <div className="lg:w-1/2 lg:pr-8 text-center lg:text-left">
            <p className="text-3xl leading-9 font-extrabold text-gray-900">
          ...
          <div className="mt-10 lg:mt-0 lg:w-1/2">
            <div className="relative">
              <img
                className="mx-auto rounded-lg shadow-lg w-full sm:w-2/3 lg:w-3/4"
